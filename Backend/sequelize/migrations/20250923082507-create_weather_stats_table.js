    ...
    await queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.createTable(
        'weather_stats',
        {
          ...
          tz: { type: Sequelize.INTEGER, allowNull: false, defaultValue:0},
          url: { type: Sequelize.STRING, allowNull: false},
          detail: { type: Sequelize.STRING, allowNull: true},
          felt: { type: Sequelize.INTEGER, allowNull: false, defaultValue:0},
          cdi: { type: Sequelize.FLOAT, allowNull: false, defaultValue:0},
          mmi: { type: Sequelize.FLOAT, allowNull: false, defaultValue:0},
          alert: { type: Sequelize.STRING, allowNull: true},
          status: { type: Sequelize.STRING, allowNull: true},
          tsunami: { type: Sequelize.INTEGER, allowNull: false, defaultValue:0},
          sig: { type: Sequelize.INTEGER, allowNull: false, defaultValue:0},
          ...
          nst: { type: Sequelize.INTEGER, allowNull: false, defaultValue:0},
          dmin: { type: Sequelize.FLOAT, allowNull: false, defaultValue:0},
          rms: { type: Sequelize.FLOAT, allowNull: false, defaultValue:0},
          gap: { type: Sequelize.FLOAT, allowNull: false, defaultValue:0},
